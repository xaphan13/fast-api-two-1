from app22.async_many_sql.schema_many_sql import (OrderCreateBody,
                                                  OrderGetQuery,
                                                  OrderUpdateBody, ProductCreateBody, ProductUpdateBody,
                                                  ProductGetQuery)
...
class AsyncOrderCRUD(AsyncBaseCRUD[Order, OrderCreateBody, OrderGetQuery,
...
class AsyncProductCRUD(AsyncBaseCRUD[Product, ProductCreateBody, ProductGetQuery,
