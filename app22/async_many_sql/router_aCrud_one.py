...
from app22.async_many_sql.schema_many_sql import (OrderCreateBody,
...
async def add_order(body: OrderCreateBody,
...
async def get_order_one(params: OrderGetQuery = Depends(),
                        db: AsyncSession = Depends(async_db.get_db)):
...
async def get_order_list(params: OrderGetQuery = Depends(),
                         db: AsyncSession = Depends(async_db.get_db)):
...
async def get_all_orders(params: OrderGetAllOrderbyQuery,
                         db: AsyncSession = Depends(async_db.get_db)):
...
async def get_all_orders_new(params: OrderGetOrderbyList,
                             db: AsyncSession = Depends(async_db.get_db)):
...
async def update_order_one(body: OrderUpdateBody, params: OrderGetQuery = Depends(),
                           db: AsyncSession = Depends(async_db.get_db)):
...
async def update_order_many(body: OrderUpdateBody, params: OrderGetQuery = Depends(),
                            db: AsyncSession = Depends(async_db.get_db)):
...
async def delete_order_many(params: OrderGetQuery = Depends(),
                            db: AsyncSession = Depends(async_db.get_db)):
...
async def delete_order_one(params: OrderGetQuery = Depends(),
                           db: AsyncSession = Depends(async_db.get_db)):
...
async def delete_product_one(params: ProductGetQuery = Depends(),
                             db: AsyncSession = Depends(async_db.get_db)):
